...
def preprocess_function(examples):
    ...
    with tokenizer.as_target_tokenizer():
        labels = tokenizer(examples["en"], max_length=512, truncation=True, padding="max_length")
...
if __name__ == "__main__":
    ...
    dataset = load_dataset("ted_talks_iwslt", language_pair=("da", "en"), year="2014", trust_remote_code=True)
